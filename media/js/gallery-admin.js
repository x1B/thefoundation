$( "document" ).ready( function()
{
   ...
   {
      globals.editingEnabled ? disableEditing() : enableEditing();
   }
   ...
   function enableEditing()
   {
      ...
      galleryTitle.innerHTML =
         '<input class="editing" name="edit-gallery-title" value="' +
         galleryTitle.innerHTML + '" />';
      ...
      longDescription.innerHTML = '<textarea class="editing">' +
         longDescription.innerHTML + "</textarea>";
   }
