/** work with rgb colors, represented as 3-element arrays */
var colors = ( function()
{
   var HEX_SHORT =
      /#([0-9abcdefABCDEF])([0-9abcdefABCDEF])([0-9abcdefABCDEF])/;

   var HEX =
      /#([0-9abcdefABCDEF]{2})([0-9abcdefABCDEF]{2})([0-9abcdefABCDEF]{2})/;
