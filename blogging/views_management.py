...
def data_for_management( request ):
   ...
   data.update( { 'gallery_form': GalleryUploadForm( { 'date': 'YYYY-mm-dd', 'show_form': False } ) } )
   return data
...
def galleries( request ):
   """List galleries."""
   return render( "meta_manage_galleries.html", request, data_for_management( request ) )
...
def images( request ):
   ...
   return render( "meta_manage_images.html", request, data_for_management( request ) )
